...
import { RESOURCE_BASE_URI, USERS_GRAPH, AUTH_ORG_CODE_CLAIM, AUTH_ORG_NAME_CLAIM, ACCESS_BLOCKED_STATUS_URI, ACCESS_ALLOWED_STATUS_URI } from '../config';
  ...
  if (orgCodeClaim) {
    ...
    if (queryResult.results.bindings.length) {
      ...
      if (status === ACCESS_BLOCKED_STATUS_URI) {
        throw new Error(`The user's organization has been blocked and does not have access.`)
      }
