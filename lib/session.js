...
import { ensureUser, ensureOrganisationForUser } from './user';
...
const ensureUserAndAccount = async function (claims, groupId) {
  ...
  ensureOrganisationForUser(personUri, claims, graph); // Fire and forget, non-critical data must not hold up the authentication flow
